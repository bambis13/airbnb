...
#   p capacity = rand(0..9)
#   p number_of_bedroom = rand(0..9)
#   p number_of_bathroom = rand(0..9)
#   p bathroom_for_guest = Faker::Boolean.boolean(0.2)
#   p postalcode = Faker::Address.postcode
#   p prefecture = Faker::Address.state
#   p town = Faker::Pokemon.location
#   p street = Faker::Address.street_name
#   p building = Faker::OnePiece.character
#   p location_x = Faker::Address.latitude
#   p location_y = Faker::Address.longitude
#   p homename = Faker::TheFreshPrinceOfBelAir.quote
#   p created_at = Faker::Time.between(DateTime.now - 1, DateTime.now)
#   p updated_at = Faker::Time.between(DateTime.now - 1, DateTime.now)
#   p random_number = (1..100)
#   p sentence = Faker::Hacker.say_something_smart
#   p boolean = Faker::Boolean.boolean(0.2)
